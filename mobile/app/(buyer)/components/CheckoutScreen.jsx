      ...
      <SafeAreaView style={buyerStyles.safe}>
        <View style={buyerStyles.container}>
          ...
          <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
            <Text style={{ color: colors.status.error, textAlign: 'center', marginBottom: 10 }}>Lỗi: {error}</Text>
      ...
      >
        <View style={checkoutStyles.optionLeft}>
          <MaterialCommunityIcons
            ...
            size={26}
            color={isSelected ? colors.text.white : colors.primary.main}
          />
          <View>
            <Text
              style={[
            ...
            <Text
              style={[
                { fontSize: 12, color: isSelected ? colors.text.white : colors.text.lighter },
          ...
          <View style={checkoutStyles.section}>
            ...
            {fetchingAddresses ? (
              ...
              <View style={{ padding: 20, alignItems: 'center' }}>
                <Text style={{ color: colors.text.lighter, textAlign: 'center' }}>
