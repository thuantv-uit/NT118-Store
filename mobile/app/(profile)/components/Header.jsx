    ...
    if (loadingProfile) {
      return (
        <View style={[styles.avatar, styles.avatarPlaceholder]}>
          <Icon name="person-outline" size={40} color={colors.border.light} />
        </View>
      );
    }
    if (avatarUrl) {
    ...
    <View style={styles.header}>
      ...
      <View style={styles.headerIcons}>
        <TouchableOpacity style={styles.iconBtn}>
          <Icon name="settings-outline" size={24} color={colors.notification.dot} />
        </TouchableOpacity>
        <TouchableOpacity style={styles.iconBtn}>
          <Icon name="cart-outline" size={24} color={colors.notification.dot} />
        </TouchableOpacity>
        <TouchableOpacity
          style={styles.iconBtn}
          onPress={() => router.push('/(buyer)/chat')}
        >
          <Icon name="chatbubble-outline" size={24} color={colors.notification.dot} />
        </TouchableOpacity>
      </View>
    </View>
  );
