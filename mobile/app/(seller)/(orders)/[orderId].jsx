    ...
    <SellerScreenLayout title={`Đơn hàng ${orderId ?? ""}`} subtitle="Theo dõi trạng thái chi tiết">
      <LinearGradient colors={["#FFE5EA", "#FAD4D6"]} start={{ x: 0, y: 0 }} end={{ x: 1, y: 1 }} style={styles.summaryCard}>
        <View style={styles.summaryIcon}>
          <MaterialCommunityIcons name="clipboard-text-outline" size={hp("3.2%")} color={colors.accent.red} />
        </View>
      ...
      <LinearGradient colors={["#FFF1F3", "#FFE3E9"]} start={{ x: 0, y: 0 }} end={{ x: 1, y: 1 }} style={styles.actionCard}>
        <Ionicons name="chatbubble-ellipses-outline" size={hp("2.6%")} color={colors.accent.red} />
        ...
        <Ionicons name="chevron-forward" size={hp("2.4%")} color={colors.accent.red} />
      </LinearGradient>
    </SellerScreenLayout>
  );
}
...
const styles = StyleSheet.create({
  ...
  summaryIcon: {
    ...
    height: wp("11%"),
    borderRadius: wp("5.5%"),
    backgroundColor: colors.overlay.white75,
    alignItems: "center",
    justifyContent: "center",
    marginRight: wp("3%"),
  },
  summaryContent: { flex: 1 },
  summaryTitle: { fontSize: hp("2%"), fontWeight: "700", color: colors.accent.redDarker },
  summarySubtitle: { fontSize: hp("1.7%"), color: colors.text.tertiary, marginTop: hp("0.2%") },
  ...
  detailLabel: { fontSize: hp("1.7%"), color: colors.text.light },
  detailValue: { fontSize: hp("1.8%"), color: colors.text.secondary, fontWeight: "600" },
  detailValueHighlight: { fontSize: hp("1.9%"), color: colors.accent.crimson, fontWeight: "700" },
  ...
  timelineLabel: { fontSize: hp("1.9%"), fontWeight: "700", color: colors.accent.redDarker },
  timelineTime: { fontSize: hp("1.6%"), color: colors.text.lighter },
  timelineDescription: { fontSize: hp("1.7%"), color: colors.text.tertiary, marginTop: hp("0.4%") },
  actionCard: {
    borderRadius: 20,
  ...
  actionText: { flex: 1 },
  actionTitle: { fontSize: hp("2%"), fontWeight: "700", color: colors.accent.redDarker },
  actionSubtitle: { fontSize: hp("1.7%"), color: colors.text.tertiary, marginTop: hp("0.2%") },
});
