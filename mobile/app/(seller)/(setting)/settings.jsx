  ...
  return (
    <SellerScreenLayout title="Cài đặt" subtitle="Điều chỉnh hoạt động cửa hàng">
      ...
      <LinearGradient colors={["#FFEAF1", "#FDE2E4"]} start={{ x: 0, y: 0 }} end={{ x: 1, y: 1 }} style={styles.supportCard}>
        <Ionicons name="help-circle-outline" size={hp("2.6%")} color={colors.accent.red} />
...
const styles = StyleSheet.create({
  ...
  groupTitle: { fontSize: hp("2.1%"), fontWeight: "700", color: colors.accent.red, marginBottom: hp("1.2%") },
  settingRow: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", paddingVertical: hp("1%") },
  settingDivider: { borderTopWidth: 1, borderTopColor: colors.border.white },
  settingRowPressed: { opacity: 0.7 },
  settingTextWrap: { flex: 1, paddingRight: wp("3%") },
  settingLabel: { fontSize: hp("1.9%"), fontWeight: "700", color: colors.accent.redDarker },
  settingDescription: { fontSize: hp("1.6%"), color: colors.text.tertiary, marginTop: hp("0.2%") },
  toggleMock: {
    width: wp("12%"),
    height: hp("3%"),
    borderRadius: hp("1.5%"),
  ...
  supportTitle: { fontSize: hp("2%"), fontWeight: "700", color: colors.accent.red },
  supportSubtitle: { fontSize: hp("1.7%"), color: colors.text.tertiary, marginTop: hp("0.4%") },
});
