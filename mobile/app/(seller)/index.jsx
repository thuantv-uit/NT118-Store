  ...
  return (
    <SafeAreaView style={sx.safe}>
      <Header
        ...
        onMessagesPress={goTo("/(seller)/chat")}
      ...
      >
        ...
        <MessageSection onPress={goTo("/(seller)/chat")} />
      </ScrollView>
      <NavigationBar />
    </SafeAreaView>
  );
...
const sx = StyleSheet.create({
  ...
  headerGreeting: { fontSize: hp("2%"), color: colors.text.cream, fontWeight: "500" },
  headerTitle: { fontSize: hp("3%"), color: colors.text.white, fontWeight: "700" },
  ...
  pressedIcon: { backgroundColor: colors.overlay.white30 },
  ...
  flashDotInactive: { backgroundColor: colors.notification.dotInactive },
  flashDotActive: { backgroundColor: colors.notification.dot },
  ...
  revenueText: { fontSize: hp("2%"), fontWeight: "600", color: colors.accent.redDarkest },
  revenueNumber: { fontSize: hp("2.6%"), fontWeight: "700", color: colors.accent.redDarker, marginTop: hp("0.4%") },
  revenueDivider: { height: 1, backgroundColor: colors.border.white, marginVertical: hp("1.6%") },
  revenueMetric: { flexDirection: "row", alignItems: "center" },
  revenueMetricText: { fontSize: hp("1.8%"), color: colors.accent.redBrown },
  ...
  productTitle: { fontSize: hp("2.2%"), fontWeight: "700", color: colors.text.primary, marginBottom: hp("0.8%") },
  productDesc: { fontSize: hp("1.8%"), lineHeight: hp("2.4%"), color: colors.text.secondary },
  bold: { fontWeight: "700" },
  ...
  notificationTitle: { marginLeft: wp("2%"), fontSize: hp("2%"), fontWeight: "700", color: colors.accent.red },
  notificationAction: { fontSize: hp("1.7%"), color: colors.accent.red, fontWeight: "600" },
  notificationActionButton: { paddingHorizontal: wp("2.2%"), paddingVertical: hp("0.5%"), borderRadius: 999, backgroundColor: colors.overlay.white55 },
  notificationItem: { flexDirection: "row", alignItems: "flex-start", paddingVertical: hp("0.8%") },
  notificationItemDivider: { borderTopWidth: 1, borderTopColor: colors.border.whiteLight },
  notificationDot: { width: wp("2.5%"), height: wp("2.5%"), borderRadius: wp("1.25%"), backgroundColor: colors.notification.dot, marginRight: wp("3%"), marginTop: hp("0.6%") },
  notificationBody: { flex: 1 },
  notificationText: { fontSize: hp("1.8%"), color: colors.text.primary, fontWeight: "600" },
  notificationTime: { fontSize: hp("1.6%"), color: colors.text.light, marginTop: hp("0.4%") },
  ...
  messageTitle: { fontSize: hp("2.2%"), fontWeight: "700", color: colors.text.primary },
  messageBadge: { paddingHorizontal: wp("3%"), paddingVertical: hp("0.6%"), backgroundColor: colors.overlay.white70, borderRadius: 999 },
  messageBadgeText: { fontSize: hp("1.5%"), fontWeight: "600", color: colors.accent.crimson },
  messageList: { marginTop: hp("1.8%") },

  avatar: { width: hp("5.6%"), height: hp("5.6%"), borderRadius: 999, backgroundColor: colors.background.primary },
  ...
  commentName: { fontSize: hp("1.9%"), fontWeight: "700", color: colors.text.primary, marginRight: wp("1.5%") },
  commentUser: { fontSize: hp("1.6%"), color: colors.text.light },
  commentDate: { fontSize: hp("1.6%"), fontWeight: "500", color: colors.text.lighter },
  commentMsg: { fontSize: hp("1.9%"), fontWeight: "500", color: colors.text.primary },
  hr: { height: 1, backgroundColor: colors.border.whiteLight, marginVertical: hp("1.2%") },
